...
public class ACPInitialization {
     ...
     * @throws IOException
     */
    public static void init(Project project, ACPExtension extension, String version, ACPLogger acpLogger) throws IOException {
        ...
        downloadACPData.exec(logger, !downloadACPData.getOutput().exists(), acpLogger);
        ...
        extractACPData.exec(logger, !project.file(Paths.SRG).exists(), acpLogger);
        ...
        downloadVersionManifest.exec(logger, !downloadVersionManifest.getOutput().exists(), acpLogger);
        ...
        downloadJson.exec(logger, !downloadJson.getOutput().exists(), acpLogger);
        ...
        extractNatives.exec(logger, !extractNatives.getOutput().exists(), acpLogger);
        ...
        downloadAssets.exec(logger, !project.file(Paths.DIR_RUN + "resources/").exists(), acpLogger);
        ...
        downloadJar.exec(logger, !project.file(Paths.BASE_JAR).exists(), acpLogger); // Fails if downloadJar.getOutput() is used here. Probably bc that isn't used in another step.
    }
}
